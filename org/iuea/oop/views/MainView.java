...
public class MainView extends JFrame {
	...
	public MainView() {
		...
		mntmNewMenuItem_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (JOptionPane.showConfirmDialog(frame, "Are you sure you want to logout?","Oddo 2019",
	...
	//creation of the panel_7, this is the container of our table and add, edit and delete buttons, it is called when the student button is pressed
				...
				table.setModel(new DefaultTableModel(
					new Object[][] {
						{"1234","ANTONIA", "MADEBE","MALE","BIT","12/456/BIT-S"},
						{"7689","JULIAS", "MUSINGUZI","MALE","BSSE","18/0045/BSSE-j"},
						{"7860","ROSE", "MAHENGE","FEMALE","BSC","15/422/BIS-S"},
						{"5342","JOHN", "AMBAKISYE","MALE","BIT-K","45/201/BSS-P"},
		...
		Submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRow()==1) {
					if(table.getRowCount()==0) {
						JOptionPane.showConfirmDialog(null, "Membership Update confirmed","Oddo 2019",
		...
		//creation of the bottom panel, it contains a label that has the copyright statement 
				...
				JLabel lblNewLabel = new JLabel("Copy right Oddo 2019");
