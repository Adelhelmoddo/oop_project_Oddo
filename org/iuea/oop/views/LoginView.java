...
public class LoginView extends MainView {
	...
	public LoginView() {
		...
		text1.setFont(new Font("Times New Roman",Font.ITALIC,18));
		...
		text2.setFont(new Font("Times New Roman",Font.ITALIC,18));
		...
		button2.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				String password=text2.getText();
                 ...
                 if(  username.contains("Oddo") && password.contains("oddo")) {
					text1.setText(null);
					text2.setText(null);
					frame1.dispose();
		...
		button3.setFont(new Font("Times New Roman",Font.HANGING_BASELINE,14));
